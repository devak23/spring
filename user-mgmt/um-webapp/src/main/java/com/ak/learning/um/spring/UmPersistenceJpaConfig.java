...
@ComponentScan({ "com.ak.learning.um.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.ak.learning.um.persistence.dao")
public class UmPersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.ak.learning.um" });
